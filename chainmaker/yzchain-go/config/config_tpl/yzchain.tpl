...
# "auth_type" should be consistent among the whole chain configuration files(e.g., bc1.yml and yzchain.yml)
# The auth type can be permissionedWithCert.
...
storage:
  ...
  blockdb_config:
    ...
    # badgerdb_config:
      # BadgerDb store path
      # store_path: ../data/yz-org1.yzchain.org/history
    ...
    # tikvdb_config:
      ...
      # grpc_connection_count: 16 # yzchain and tikv connect count, default: 4
...
vm:
  ...
  go:
    ...
    # Mount data path in yzchain, include contracts, uds socks
    data_mount_path: ../data/{org_id}/go

    # Mount log path in yzchain
    log_mount_path: ../log/{org_id}/go

    # Communication protocol, used for yzchain and docker manager communication
    ...
    # Priority: yzchain.yml > vm.yml > default settings

...
# The blockchain auth type, shoudle be consistent with auth type in node config (e.g., yzchain.yml)
...
contract:
  ...
  # If it is true, storage.statedb_config.provider in yzchain.yml should be sql.

...
import (
	...
	"chainmaker.org/chainmaker-go/tools/yzc/types"
	"chainmaker.org/chainmaker-go/tools/yzc/util"
...
// --admin-key-file-paths=./testdata/crypto-config/yz-org1.yzchain.org/user/admin1/admin1.sign.key
// --admin-crt-file-paths=./testdata/crypto-config/yz-org1.yzchain.org/user/admin1/admin1.sign.crt
// --sync-result=true \
// --params="{}"

...
func ParallelCMD() *cobra.Command {
	...
	flags.StringVarP(&userCrtPathsString, "user-crts", "K", "../../config/crypto-config/yz-org1.yzchain.org/user/client1/client1.tls.crt,../../config/crypto-config/yz-org2.yzchain.org/user/client1/client1.tls.crt", "specify user crt path")
	flags.StringVarP(&userKeyPathsString, "user-keys", "u", "../../config/crypto-config/yz-org1.yzchain.org/user/client1/client1.tls.key,../../config/crypto-config/yz-org2.yzchain.org/user/client1/client1.tls.key", "specify user key path")
	flags.StringVarP(&orgIDsString, "org-IDs", "I", "yz-org1,yz-org2", "specify user key path")
	...
	flags.StringVarP(&caPathsString, "ca-path", "P", "../../config/crypto-config/yz-org1.yzchain.org/ca,../../config/crypto-config/yz-org2.yzchain.org/ca", "specify ca path")
	flags.BoolVarP(&useTLS, "use-tls", "t", false, "specify whether use tls")
	flags.StringVar(&orgIds, "org-ids", "yz-org1,yz-org2,yz-org3,yz-org4", "orgIds of admin")
	flags.StringVar(&adminSignKeys, "admin-sign-keys", "../../config/crypto-config/yz-org1.yzchain.org/user/admin1/admin1.sign.key,../../config/crypto-config/yz-org2.yzchain.org/user/admin1/admin1.sign.key,../../config/crypto-config/yz-org3.yzchain.org/user/admin1/admin1.sign.key,../../config/crypto-config/yz-org4.yzchain.org/user/admin1/admin1.sign.key", "adminSignKeys of admin")
	flags.StringVar(&adminSignCrts, "admin-sign-crts", "../../config/crypto-config/yz-org1.yzchain.org/user/admin1/admin1.sign.crt,../../config/crypto-config/yz-org2.yzchain.org/user/admin1/admin1.sign.crt,../../config/crypto-config/yz-org3.yzchain.org/user/admin1/admin1.sign.crt,../../config/crypto-config/yz-org4.yzchain.org/user/admin1/admin1.sign.crt", "adminSignCrts of admin")
	...
	flags.Uint32Var(&authTypeUint32, "auth-type", 1, "yzchain auth type. PermissionedWithCert:1")
...
func parallel(parallelMethod string) error {
	...
	fmt.Println("Statistics for the entire test end")

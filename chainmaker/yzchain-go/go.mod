...
replace (
	chainmaker.org/chainmaker/chainconf/v2 v2.3.2 => ../chain-module/chainconf
	chainmaker.org/chainmaker/common/v2 v2.3.2 => ../chain-module/common
	chainmaker.org/chainmaker/consensus-raft/v2 v2.3.2 => ../chain-module/consensus-raft
	chainmaker.org/chainmaker/consensus-solo/v2 v2.3.0 => ../chain-module/consensus-solo
	chainmaker.org/chainmaker/consensus-tbft/v2 v2.3.3 => ../chain-module/consensus-tbft
	chainmaker.org/chainmaker/consensus-utils/v2 v2.3.3 => ../chain-module/consensus-utils
	chainmaker.org/chainmaker/localconf/v2 v2.3.2 => ../chain-module/localconf
	chainmaker.org/chainmaker/logger/v2 v2.3.0 => ../chain-module/logger
	chainmaker.org/chainmaker/net-common v1.3.1 => ../chain-module/net-common
	chainmaker.org/chainmaker/net-libp2p v1.2.3 => ../chain-module/net-libp2p
	chainmaker.org/chainmaker/pb-go/v2 v2.3.3 => ../chain-module/pb-go
	chainmaker.org/chainmaker/protocol/v2 v2.3.3 => ../chain-module/protocol
	chainmaker.org/chainmaker/sdk-go/v2 v2.3.3 => ../chain-module/sdk-go
	chainmaker.org/chainmaker/store/v2 v2.3.4 => ../chain-module/store
	chainmaker.org/chainmaker/txpool-batch/v2 v2.3.2 => ../chain-module/txpool-batch
	chainmaker.org/chainmaker/txpool-normal/v2 v2.3.2 => ../chain-module/txpool-normal
	chainmaker.org/chainmaker/utils/v2 v2.3.3 => ../chain-module/utils
	chainmaker.org/chainmaker/vm-engine/v2 v2.3.4 => ../chain-module/vm-engine
	chainmaker.org/chainmaker/vm-evm/v2 v2.3.3 => ../chain-module/vm-evm
	chainmaker.org/chainmaker/vm-native/v2 v2.3.3 => ../chain-module/vm-native
	chainmaker.org/chainmaker/vm/v2 v2.3.3 => ../chain-module/vm

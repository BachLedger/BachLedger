...
// SetLivenessTicker set time interval for doing a liveliness check
...
// SetMinLagThreshold set the minimum value local block height lags behind maximum block height

...
func TestNodeStatusMsg(t *testing.T) {
	...
	mockLedger.SetLastBlock(&commonPb.Block{Header: &commonPb.BlockHeader{BlockHeight: 180}})
...
func TestNextHeightToReq(t *testing.T) {
	...
	mockLedger.SetLastBlock(&commonPb.Block{Header: &commonPb.BlockHeader{BlockHeight: 90}})

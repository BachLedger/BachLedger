...
var (
	TestPrivKeyFile = "../../../../config/yz-org1/certs/node/consensus1/consensus1.sign.key"
	TestCertFile    = "../../../../config/yz-org1/certs/node/consensus1/consensus1.sign.crt"
)
...
func TestSchedule(t *testing.T) {
	...
	txSet, contractEven, err := scheduler.GetResultMaps(block, txBatch, snapshot)
	require.Nil(t, err)

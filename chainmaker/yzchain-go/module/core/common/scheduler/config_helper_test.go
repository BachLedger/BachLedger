...
func TestVerifyOptimizeChargeGasTx_NoChargeGasTx(t *testing.T) {
	...
	assert.Equal(t, nil, fmt.Errorf("charge gas tx is missing"))
}
...
func TestVerifyOptimizeChargeGasTx_WithWrongAccountAddress(t *testing.T) {
	...
	assert.Equal(t, nil, fmt.Errorf("missing some account to charge gas => `%v`", Address_Client1_Org1_ZXL))
}
...
func TestVerifyOptimizeChargeGasTx_WithLessAddress(t *testing.T) {
	...
	assert.Equal(t, nil, fmt.Errorf("gas need to charging is not correct, expect 4 account, got 3 account"))
}
...
func TestVerifyOptimizeChargeGasTx_WithMoreAddress(t *testing.T) {
	...
	assert.Equal(t, nil, fmt.Errorf("gas need to charging is not correct, expect 4 account, got 5 account"))
}

...
//		ledgerCache.EXPECT().GetLastBlock().Return(lastBlock).AnyTimes()
//
...
//
//	block := createBlock(0)
//	ledgerCache.EXPECT().GetLastBlock().Return(block).AnyTimes()
...
//					ledgerCache = newMockLedgerCache(t)
//					ledgerCache.EXPECT().CurrentHeight().AnyTimes()
//					ledgerCache.EXPECT().GetLastBlock().AnyTimes()
//					return ledgerCache
//				}(),
//				proposalCache: proposalCache,
//				chainConf:     chainConf,
...
//
//	ledgerCache.EXPECT().GetLastBlock().Return(commonBlock).AnyTimes()
//	ledgerCache.EXPECT().SetLastBlock(gomock.Any()).AnyTimes()
//	ledgerCache.EXPECT().CurrentHeight().AnyTimes()
...
//				ledgerCache: func() protocol.LedgerCache {
//					ledgerCache := newMockLedgerCache(t)
//					ledgerCache.EXPECT().GetLastBlock().Return(nil).AnyTimes()
//					return ledgerCache
//				}(),
//				proposalCache:         newMockProposalCache(t),
//				log:                   newMockLogger(t),
...
//				ledgerCache: func() protocol.LedgerCache {
//					ledgerCache := newMockLedgerCache(t)
//					ledgerCache.EXPECT().GetLastBlock().Return(createBlock(0)).AnyTimes()
//					return ledgerCache
//				}(),
//				proposalCache:         newMockProposalCache(t),
//				log:                   newMockLogger(t),
...
//				ledgerCache: func() protocol.LedgerCache {
//					ledgerCache := newMockLedgerCache(t)
//					ledgerCache.EXPECT().GetLastBlock().Return(createBlock(1)).AnyTimes()
//					return ledgerCache
//				}(),
//				proposalCache:         newMockProposalCache(t),
//				log:                   newMockLogger(t),

...
func TestBlockVerifierImpl_VerifyBlock(t *testing.T) {
	...
	proposedCache := cache.NewProposalCache(mock.NewMockChainConf(ctl), ledgerCache, commitedLedgerCache, log)
	...
	verifier := &BlockVerifierImpl{
		...
		commitedLedgerCache: ledgerCache,
	...
	conf := &common.VerifierBlockConf{
		...
		Log:                 verifier.log,
		CommitedLedgerCache: verifier.commitedLedgerCache,
		Ac:                  verifier.ac,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			v := &BlockVerifierImpl{
				...
				commitedLedgerCache:   tt.fields.ledgerCache,

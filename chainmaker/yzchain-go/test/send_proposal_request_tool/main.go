...
var (
	...
	initParams  string
	prettyJson  bool
	OrgIdFormat = "yz-org%s.chainmaker.org"
...
func main() {
	...
	mainFlags.StringVarP(&userKeyPath, "user-key", "k", "../../config/crypto-config/yz-org1.yzchain.org/user/client1/client1.tls.key", "specify user key path")
	mainFlags.StringVarP(&userCrtPath, "user-crt", "c", "../../config/crypto-config/yz-org1.yzchain.org/user/client1/client1.tls.crt", "specify user crt path")
	mainFlags.StringVarP(&caPathsString, "ca-path", "P", "../../config/crypto-config/yz-org1.yzchain.org/ca,../../config/crypto-config/yz-org2.yzchain.org/ca", "specify ca path")
	...
	mainFlags.StringVarP(&orgId, "org-id", "O", "yz-org1", "specify org id")
	mainFlags.StringVarP(&contractName, "contract-name", "n", "contract1", "specify contract name")
	mainFlags.StringVar(&orgIds, "org-ids", "yz-org1,yz-org2,yz-org3,yz-org4", "orgIds of admin")
	//mainFlags.StringVar(&orgIds, "org-ids", "yz-org1,yz-org2,yz-org3,yz-org4", "orgIds of admin")
	mainFlags.StringVar(&adminSignKeys, "admin-sign-keys", "../../config/crypto-config/yz-org1.yzchain.org/user/admin1/admin1.sign.key,../../config/crypto-config/yz-org2.yzchain.org/user/admin1/admin1.sign.key,../../config/crypto-config/yz-org3.yzchain.org/user/admin1/admin1.sign.key,../../config/crypto-config/yz-org4.yzchain.org/user/admin1/admin1.sign.key", "adminSignKeys of admin")
	mainFlags.StringVar(&adminSignCrts, "admin-sign-crts", "../../config/crypto-config/yz-org1.yzchain.org/user/admin1/admin1.sign.crt,../../config/crypto-config/yz-org2.yzchain.org/user/admin1/admin1.sign.crt,../../config/crypto-config/yz-org3.yzchain.org/user/admin1/admin1.sign.crt,../../config/crypto-config/yz-org4.yzchain.org/user/admin1/admin1.sign.crt", "adminSignCrts of admin")

...
const (
	...
	prePathFmt  = certPathPrefix + "crypto-config/yz-org%s.yzchain.org/user/admin1/"
	OrgIdFormat = "yz-org%d.yzchain.org"
	tps         = 10000 //

	userKeyPathFormat  = certPathPrefix + "crypto-config/yz-org%d.yzchain.org/user/client1/client1.sign.key"
	userCertPathFormat = certPathPrefix + "crypto-config/yz-org%d.yzchain.org/user/client1/client1.sign.crt"
)

var (
	caPaths = [][]string{
		{certPathPrefix + "crypto-config/yz-org1.yzchain.org/ca"},
		{certPathPrefix + "crypto-config/yz-org2.yzchain.org/ca"},
		{certPathPrefix + "crypto-config/yz-org3.yzchain.org/ca"},
		{certPathPrefix + "crypto-config/yz-org4.yzchain.org/ca"},
		{certPathPrefix + "crypto-config/yz-org5.yzchain.org/ca"},
		{certPathPrefix + "crypto-config/yz-org6.yzchain.org/ca"},
		{certPathPrefix + "crypto-config/yz-org7.yzchain.org/ca"},
	}
	userKeyPaths = []string{
		certPathPrefix + "crypto-config/yz-org1.yzchain.org/user/client1/client1.sign.key",
		certPathPrefix + "crypto-config/yz-org2.yzchain.org/user/client1/client1.sign.key",
		certPathPrefix + "crypto-config/yz-org3.yzchain.org/user/client1/client1.sign.key",
		certPathPrefix + "crypto-config/yz-org4.yzchain.org/user/client1/client1.sign.key",
		certPathPrefix + "crypto-config/yz-org5.yzchain.org/user/client1/client1.sign.key",
		certPathPrefix + "crypto-config/yz-org6.yzchain.org/user/client1/client1.sign.key",
		certPathPrefix + "crypto-config/yz-org7.yzchain.org/user/client1/client1.sign.key",
	}
	userCrtPaths = []string{
		certPathPrefix + "crypto-config/yz-org1.yzchain.org/user/client1/client1.sign.crt",
		certPathPrefix + "crypto-config/yz-org2.yzchain.org/user/client1/client1.sign.crt",
		certPathPrefix + "crypto-config/yz-org3.yzchain.org/user/client1/client1.sign.crt",
		certPathPrefix + "crypto-config/yz-org4.yzchain.org/user/client1/client1.sign.crt",
		certPathPrefix + "crypto-config/yz-org5.yzchain.org/user/client1/client1.sign.crt",
		certPathPrefix + "crypto-config/yz-org6.yzchain.org/user/client1/client1.sign.crt",
		certPathPrefix + "crypto-config/yz-org7.yzchain.org/user/client1/client1.sign.crt",
	}
	orgIds = []string{
		"yz-org1.yzchain.org",
		"yz-org2.yzchain.org",
...
func testCreate(sk3 crypto.PrivateKey, client apiPb.RpcNodeClient, chainId string, wasmType int) {
	...
	common.CreateContract(sk3, &client, CHAIN1, wasmName, wasmPath, commonPb.RuntimeType_EVM)

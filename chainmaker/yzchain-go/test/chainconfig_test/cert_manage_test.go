...
func TestCertAdd(t *testing.T) {
	...
	// 添加证书 ../config/crypto-config/yz-org1.yzchain.org/user/client1/client1.sign.crt
...
func TestCertQuery(t *testing.T) {
	...
	// 构造Payload
	// 查询证书 ../config/crypto-config/yz-org1.yzchain.org/user/client1/client1.sign.crt
...
func TestCertDelete(t *testing.T) {
	...
	// 构造Payload
	// 删除证书 ../config/crypto-config/yz-org1.yzchain.org/user/client1/client1.sign.crt
	pairs := []*commonPb.KeyValuePair{
		{
			Key:   "cert_hashes",
...
func TestCertFrozen(t *testing.T) {
	...
	require.True(t, len(txId) > 0)
	// 构造Payload
	// 冻结证书 ../config/crypto-config/yz-org1.yzchain.org/user/client1/client1.sign.crt
	pairs := []*commonPb.KeyValuePair{
		//{
...
func TestCertUnfrozen(t *testing.T) {
	...
	require.True(t, len(txId) > 0)
	// 构造Payload
	// 解冻证书 ../config/crypto-config/yz-org1.yzchain.org/user/client1/client1.sign.crt
	pairs := []*commonPb.KeyValuePair{
		{
			Key:   "certs",
...
func TestCertRevocation(t *testing.T) {
	...
	// 构造Payload
	var pairs []*commonPb.KeyValuePair
	// 吊销证书 ../config/crypto-config/yz-org1.yzchain.org/user/client1/client1.sign.crt
	pairs = append(pairs, &commonPb.KeyValuePair{
		Key: "cert_crl",
		// 多个就换行就行

...
var (
	...
	OrgIdFormat        = "yz-org%s.yzchain.org"
	UserKeyPathFmt     = certPathPrefix + "/crypto-config/yz-org%s.yzchain.org/user/client1/client1.tls.key"
	UserCrtPathFmt     = certPathPrefix + "/crypto-config/yz-org%s.yzchain.org/user/client1/client1.tls.crt"
	UserSignKeyPathFmt = certPathPrefix + "/crypto-config/yz-org%s.yzchain.org/user/client1/client1.sign.key"
	UserSignCrtPathFmt = certPathPrefix + "/crypto-config/yz-org%s.yzchain.org/user/client1/client1.sign.crt"
	//UserSignKeyPathFmt  = certPathPrefix + "/crypto-config/yz-org%s.yzchain.org/user/light1/light1.sign.key"
	//UserSignCrtPathFmt  = certPathPrefix + "/crypto-config/yz-org%s.yzchain.org/user/light1/light1.sign.crt"
	AdminSignKeyPathFmt = certPathPrefix + "/crypto-config/yz-org%s.yzchain.org/user/admin1/admin1.sign.key"
	AdminSignCrtPathFmt = certPathPrefix + "/crypto-config/yz-org%s.yzchain.org/user/admin1/admin1.sign.crt"
	...
	// caPaths    = []string{"D:/develop/workspace/chainMaker/yzchain-go/build/crypto-config/yz-org5.yzchain.org/ca"}

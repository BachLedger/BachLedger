...
def get_user_addr(org, user):
    ...
    if gl.ACCOUNT_TYPE=="cert":
        cmc=f"./cmc address cert-to-addr {gl.CRYPTO_CONFIG_PATH}/yz-org{org}.chainmaker.org/certs/user/admin1/admin1.sign.crt"
    if gl.ACCOUNT_TYPE=="pwk":
        cmc = f"./cmc address pk-to-addr {gl.CRYPTO_CONFIG_PATH}/yz-org{org}.chainmaker.org/keys/user/admin/admin.pem"

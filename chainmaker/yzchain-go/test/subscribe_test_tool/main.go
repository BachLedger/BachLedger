...
func main() {
	...
	mainFlags.StringVarP(&userKeyPath, "userkey", "k", "../../config/crypto-config/yz-org1.yzchain.org/user/client1/client1.tls.key", "specify user key path")
	...
	mainFlags.StringArrayVarP(&caPaths, "ca-path", "P", []string{"../../config/crypto-config/yz-org1.yzchain.org/ca"}, "specify ca path")
	...
	mainFlags.StringVarP(&orgId, "org-id", "O", "yz-org1.yzchain.org", "specify org id")

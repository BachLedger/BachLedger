...
func prePathFmt() string {
	return certPathPrefix + "/crypto-config/yz-org%s.chainmaker.org/user/admin1/"
}
func userKeyPath() string {
	return certPathPrefix + "/crypto-config/yz-org1.yzchain.org/user/client1/client1.sign.key"
}
func userCrtPath() string {
	return certPathPrefix + "/crypto-config/yz-org1.yzchain.org/user/client1/client1.sign.crt"
}

func adminCrtPath() string {
	return certPathPrefix + "/crypto-config/yz-org1.yzchain.org/user/admin1/admin1.sign.crt"
}

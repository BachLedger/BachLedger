...
const (
	...
	adminKeyPath    = certPathPrefix + "/crypto-config/yz-org1.yzchain.org/user/admin1/admin1.sign.key"
	adminCrtPath    = certPathPrefix + "/crypto-config/yz-org1.yzchain.org/user/admin1/admin1.sign.crt"
...
// var caPaths = []string{certPathPrefix + "/certs/yz-org1/ca"}
var caPaths = []string{certPathPrefix + "/crypto-config/yz-org1.yzchain.org/ca"}
var AbiJson = ""

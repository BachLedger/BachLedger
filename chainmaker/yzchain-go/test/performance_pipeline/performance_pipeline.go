...
var (
	caPaths = [][]string{
		{certPathPrefix + "yz-org1.yzchain.org/ca/"},
		{certPathPrefix + "yz-org2.yzchain.org/ca/"},
		{certPathPrefix + "yz-org3.yzchain.org/ca/"},
		{certPathPrefix + "yz-org4.yzchain.org/ca/"},
	}
	userKeyPaths = []string{
		certPathPrefix + "yz-org1.yzchain.org/user/client1/client1.sign.key",
		certPathPrefix + "yz-org2.yzchain.org/user/client1/client1.sign.key",
		certPathPrefix + "yz-org3.yzchain.org/user/client1/client1.sign.key",
		certPathPrefix + "yz-org4.yzchain.org/user/client1/client1.sign.key",
	}
	userCrtPaths = []string{
		certPathPrefix + "yz-org1.yzchain.org/user/client1/client1.sign.crt",
		certPathPrefix + "yz-org2.yzchain.org/user/client1/client1.sign.crt",
		certPathPrefix + "yz-org3.yzchain.org/user/client1/client1.sign.crt",
		certPathPrefix + "yz-org4.yzchain.org/user/client1/client1.sign.crt",
	}
	orgIds = []string{
		"yz-org1.yzchain.org",
		"yz-org2.yzchain.org",

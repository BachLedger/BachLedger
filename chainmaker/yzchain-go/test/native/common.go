...
var (
	...
	//userKeyPath         = certPathPrefix + "/crypto-config/yz-org1.yzchain.org/user/client1/client1.tls.key"
	userKeyPath = certPathPrefix + "/crypto-config/yz-org1.yzchain.org/user/client1/client1.sign.key"
	//userCrtPath         = certPathPrefix + "/crypto-config/yz-org1.yzchain.org/user/client1/client1.tls.crt"
	...
	err                 error
	txId                string
	UserKeyPathFmt      = certPathPrefix + "/crypto-config/yz-org%s.chainmaker.org/user/client1/client1.tls.key"
	UserCrtPathFmt      = certPathPrefix + "/crypto-config/yz-org%s.chainmaker.org/user/client1/client1.tls.crt"
	UserSignKeyPathFmt  = certPathPrefix + "/crypto-config/yz-org%s.chainmaker.org/user/client1/client1.sign.key"
	UserSignCrtPathFmt  = certPathPrefix + "/crypto-config/yz-org%s.chainmaker.org/user/client1/client1.sign.crt"
	AdminSignKeyPathFmt = certPathPrefix + "/crypto-config/yz-org%s.chainmaker.org/user/admin1/admin1.sign.key"
	AdminSignCrtPathFmt = certPathPrefix + "/crypto-config/yz-org%s.chainmaker.org/user/admin1/admin1.sign.crt"

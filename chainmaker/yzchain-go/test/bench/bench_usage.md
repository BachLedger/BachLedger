...
- orgid : specify an organization as a party to the transaction, like 'yz-org1'
- orglist : organization list, which is used for multi-party signature when creating contract, like 'yz-org1,yz-org2,yz-org3,yz-org4'
...
## Test by GRPC
```
./bench  -url=localhost:17898 -num=10 -method=grpc -cert_root_path=../config -orgid=yz-org1 -orglist=yz-org1,yz-org2,yz-org3,yz-org4 -update_height=100
```

...
function start_vm_go() {
  container_name=VM-GO-yz-org$1.ci-chain1
  ...
  xsed "s%enable: false%enable: true%g" ./config/yz-org$1.yzchain.org/yzchain.yml
...
start_vm_go 1 "./data/yz-org1.yzchain.org/go" "./log/yz-org1.yzchain.org/go" 32351 22351
start_vm_go 2 "./data/yz-org2.yzchain.org/go" "./log/yz-org2.yzchain.org/go" 32352 22352
start_vm_go 3 "./data/yz-org3.yzchain.org/go" "./log/yz-org3.yzchain.org/go" 32353 22353
start_vm_go 4 "./data/yz-org4.yzchain.org/go" "./log/yz-org4.yzchain.org/go" 32354 22354
sleep 3

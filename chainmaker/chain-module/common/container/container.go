...
func (nb *namedBinding) Clone() *namedBinding {
	clone := &namedBinding{
		defaultBinding: nb.defaultBinding.Clone(),
		namedBinding:   make(map[string]*binding, len(nb.namedBinding)),
	}
	for k, v := range nb.namedBinding {

...
var (
	...
	secondSignerCertFilePath    = "../../testdata/crypto-config/yz-org2.yzchain.org/user/client1/client1.sign.crt"
	secondSignerPrivKeyFilePath = "../../testdata/crypto-config/yz-org2.yzchain.org/user/client1/client1.sign.key"
	secondSignerOrgId           = "yz-org2.yzchain.org"
)
...
func main() {
	...
	testCreateUserContract(cc, claimContractName, claimVersion, claimByteCodePath,
		common.RuntimeType_EVM, []*common.KeyValuePair{}, true, usernames...)

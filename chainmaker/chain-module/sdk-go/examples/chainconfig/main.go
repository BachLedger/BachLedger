...
func testChainConfig(client *sdk.ChainClient) {
	...
	raw, err := ioutil.ReadFile("../../testdata/crypto-config/yz-org5.yzchain.org/ca/ca.crt")
	if err != nil {
		log.Fatalln(err)
	}
	...
	raw, err = ioutil.ReadFile("../../testdata/crypto-config/yz-org6.yzchain.org/ca/ca.crt")
	if err != nil {
		log.Fatalln(err)
	}
	trustRootOrgId = examples.OrgId5

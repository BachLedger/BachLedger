...
func testUserContractTokenEVM(sdkPath string) {
	...
	//CREATE EVM token contract resp: message:"OK" contract_result:<result:"\n(a90b890d4b2577b3d8c9bb487fcb5e90167e4842\022\0051.0.0\030\005*<\n\026yz-org1.yzchain.org\020\001\032 $p^\215Q\366\236\2120\007\233eW\210\220\3746\250\027\331h\212\024\253\370Ecl\214J'\322" message:"OK" > tx_id:"df90acc322724e1e852313f510bbbf81dbb65774ac5c4aa4a83a7258f002d8eb"
	//====================== 查看余额 ======================

...
const (
	...
	caCertPath               = "../../testdata/crypto-config/yz-org1.yzchain.org/ca/ca.crt"
	userTlsCrtPath           = "../../testdata/crypto-config/yz-org1.yzchain.org/user/client1/client1.tls.crt"
	userTlsKeyPath           = "../../testdata/crypto-config/yz-org1.yzchain.org/user/client1/client1.tls.key"
)
...
func testUserContractClaimCreate(client *sdk.ChainClient, usernames ...string) {
	payload, err := client.CreateContractCreatePayload(claimContractName, claimVersion, claimByteCodePath,
		common.RuntimeType_EVM, []*common.KeyValuePair{})
	if err != nil {
		log.Fatalln(err)
	}

...
const (
	...
	rpcServerTlsCertFile    = "./testdata/crypto-config/yz-org1.yzchain.org/node/consensus1/consensus1.tls.crt"
	rpcServerTlsPrivKeyFile = "./testdata/crypto-config/yz-org1.yzchain.org/node/consensus1/consensus1.tls.key"
)

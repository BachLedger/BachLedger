...
func (cc *ChainClient) proposalRequestWithTimeout(payload *common.Payload, endorsers []*common.EndorsementEntry,
	...
	return cc.proposalRequestWithTimeoutAndPayer(payload, endorsers, nil, timeout)
}

func (cc *ChainClient) proposalRequestWithTimeoutAndPayer(payload *common.Payload, endorsers []*common.EndorsementEntry,
	payer *common.EndorsementEntry, timeout int64) (*common.TxResponse, error) {

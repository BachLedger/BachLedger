...
func (m *MockLedgerCache) GetLastBlock() *common.Block {
	m.ctrl.T.Helper()
...
func (mr *MockLedgerCacheMockRecorder) GetLastBlock() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetLastBlock", reflect.TypeOf((*MockLedgerCache)(nil).GetLastBlock))
}

// SetLastBlock mocks base method.
func (m *MockLedgerCache) SetLastBlock(b *common.Block) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetLastBlock", b)
}

// SetLastBlock indicates an expected call of SetLastBlock.
func (mr *MockLedgerCacheMockRecorder) SetLastBlock(b interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetLastBlock", reflect.TypeOf((*MockLedgerCache)(nil).SetLastBlock), b)
}

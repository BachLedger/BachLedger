...
func (m *MockTxScheduler) ExecuteTx(tx *common.Transaction, snapshot protocol.Snapshot, block *common.Block) *protocol.ExecuteTxResult {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ExecuteTx", tx, snapshot, block)
	ret0, _ := ret[0].(*protocol.ExecuteTxResult)
	return ret0
}

// ExecuteTx indicates an expected call of ExecuteTx.
func (mr *MockTxSchedulerMockRecorder) ExecuteTx(tx, snapshot, block interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ExecuteTx", reflect.TypeOf((*MockTxScheduler)(nil).ExecuteTx), tx, snapshot, block)
}

// GetResultMaps mocks base method.
func (m *MockTxScheduler) GetResultMaps(block *common.Block, txBatch []*common.Transaction, snapshot protocol.Snapshot) (map[string]*common.TxRWSet, map[string][]*common.ContractEvent, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetResultMaps", block, txBatch, snapshot)
...
// GetResultMaps indicates an expected call of GetResultMaps.
func (mr *MockTxSchedulerMockRecorder) GetResultMaps(block, txBatch, snapshot interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetResultMaps", reflect.TypeOf((*MockTxScheduler)(nil).GetResultMaps), block, txBatch, snapshot)
}

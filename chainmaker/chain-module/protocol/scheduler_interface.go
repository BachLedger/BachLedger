...
type TxScheduler interface {
	...
	GetResultMaps(block *common.Block, txBatch []*common.Transaction, snapshot Snapshot) (map[string]*common.TxRWSet, map[string][]*common.ContractEvent, error)
	...
	ExecuteTx(tx *common.Transaction, snapshot Snapshot, block *common.Block) *ExecuteTxResult
}

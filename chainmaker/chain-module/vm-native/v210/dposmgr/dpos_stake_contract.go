...
import (
	...
	common210 "chainmaker.org/chainmaker/vm-native/v2/v210/common"
...
func registerDPoSStakeContractMethods(log protocol.Logger) map[string]common.ContractFunc {
	...
	methodMap[syscontract.DPoSStakeFunction_GET_ALL_CANDIDATES.String()] = common210.WrapResultFunc(
		stakeRuntime.GetAllCandidates)
	methodMap[syscontract.DPoSStakeFunction_GET_VALIDATOR_BY_ADDRESS.String()] = common210.WrapResultFunc(
		stakeRuntime.GetValidatorByAddress)
	methodMap[syscontract.DPoSStakeFunction_DELEGATE.String()] = common210.WrapResultFunc(
		stakeRuntime.Delegate)
	methodMap[syscontract.DPoSStakeFunction_GET_DELEGATIONS_BY_ADDRESS.String()] = common210.WrapResultFunc(
		stakeRuntime.GetDelegationsByAddress)
	methodMap[syscontract.DPoSStakeFunction_GET_USER_DELEGATION_BY_VALIDATOR.String()] = common210.WrapResultFunc(
		stakeRuntime.GetUserDelegationByValidator)
	methodMap[syscontract.DPoSStakeFunction_UNDELEGATE.String()] = common210.WrapResultFunc(
		stakeRuntime.UnDelegate)
	methodMap[syscontract.DPoSStakeFunction_READ_EPOCH_BY_ID.String()] = common210.WrapResultFunc(
		stakeRuntime.ReadEpochByID)
	methodMap[syscontract.DPoSStakeFunction_READ_LATEST_EPOCH.String()] = common210.WrapResultFunc(
		stakeRuntime.ReadLatestEpoch)
	methodMap[syscontract.DPoSStakeFunction_SET_NODE_ID.String()] = common210.WrapResultFunc(
		stakeRuntime.SetNodeID)
	methodMap[syscontract.DPoSStakeFunction_GET_NODE_ID.String()] = common210.WrapResultFunc(
		stakeRuntime.GetNodeID)
	methodMap[syscontract.DPoSStakeFunction_READ_MIN_SELF_DELEGATION.String()] = common210.WrapResultFunc(
		stakeRuntime.ReadMinSelfDelegation)
	//methodMap[syscontract.DPoSStakeFunction_UPDATE_MIN_SELF_DELEGATION.String()] = common210.WrapResultFunc(
	//DPoSStakeRuntime.UpdateMinSelfDelegation)
	methodMap[syscontract.DPoSStakeFunction_READ_EPOCH_VALIDATOR_NUMBER.String()] = common210.WrapResultFunc(
		stakeRuntime.ReadEpochValidatorNumber)
	//methodMap[syscontract.DPoSStakeFunction_UPDATE_EPOCH_VALIDATOR_NUMBER.String()] = common210.WrapResultFunc(
	//DPoSStakeRuntime.UpdateEpochValidatorNumber)
	methodMap[syscontract.DPoSStakeFunction_READ_EPOCH_BLOCK_NUMBER.String()] = common210.WrapResultFunc(
		stakeRuntime.ReadEpochBlockNumber)
	methodMap[syscontract.DPoSStakeFunction_READ_SYSTEM_CONTRACT_ADDR.String()] = common210.WrapResultFunc(
		stakeRuntime.ReadSystemContractAddr)
	//methodMap[syscontract.DPoSStakeFunction_UPDATE_EPOCH_BLOCK_NUMBER.String()] = common210.WrapResultFunc(
	//DPoSStakeRuntime.UpdateEpochBlockNumber)
	methodMap[syscontract.DPoSStakeFunction_READ_COMPLETE_UNBOUNDING_EPOCH_NUMBER.String()] = common210.WrapResultFunc(

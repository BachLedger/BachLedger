...
func registerDPoSERC20ContractMethods(log protocol.Logger) map[string]common.ContractFunc {
	...
	methodMap[syscontract.DPoSERC20Function_GET_BALANCEOF.String()] = common.WrapResultFunc(dposRuntime.BalanceOf)
	methodMap[syscontract.DPoSERC20Function_TRANSFER.String()] = common.WrapResultFunc(dposRuntime.Transfer)
	//methodMap[syscontract.DPoSERC20Function_TRANSFER_FROM.String()] = common.WrapResultFunc(  dposRuntime.TransferFrom)
	//methodMap[syscontract.DPoSERC20Function_GET_ALLOWANCE.String()] = common.WrapResultFunc(  dposRuntime.Allowance)
	//methodMap[syscontract.DPoSERC20Function_APPROVE.String()] = common.WrapResultFunc(  dposRuntime.Approve)
	methodMap[syscontract.DPoSERC20Function_MINT.String()] = common.WrapResultFunc(dposRuntime.Mint)
	//methodMap[syscontract.DPoSERC20Function_BURN.String()] = common.WrapResultFunc(  dposRuntime.Burn)
	//methodMap[syscontract.DPoSERC20Function_TRANSFER_OWNERSHIP.String()] = common.WrapResultFunc(
	//dposRuntime.TransferOwnership)
	methodMap[syscontract.DPoSERC20Function_GET_OWNER.String()] = common.WrapResultFunc(dposRuntime.Owner)
	methodMap[syscontract.DPoSERC20Function_GET_DECIMALS.String()] = common.WrapResultFunc(dposRuntime.Decimals)

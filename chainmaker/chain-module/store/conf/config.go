...
func (dbc *DbConfig) GetDbConfig() map[string]interface{} {
	switch strings.ToLower(dbc.Provider) {
	case DbconfigProviderLeveldb:
		return dbc.LevelDbConfig
	case DbconfigProviderBadgerdb:
		return dbc.BadgerDbConfig
	case DbconfigProviderTikvdb:
		return dbc.TikvDbConfig
	default:
		return map[string]interface{}{}
	}
	return nil
